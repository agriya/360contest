...
<div class="userAddWalletAmounts form container-fluid"> 
	<div class="admin-center-block clearfix">
		<div class="hor-space">
			<div class="thumbnail">
				<?php echo $this->Form->create('UserAddWalletAmounts', array('action' => 'add_fund', 'class' => 'form-large-fields form-horizontal'));?>
				  <fieldset>
				  <?php
				  ...
				  <div class="submit-block clearfix"><?php echo $this->Form->end(__l('Add Fund'));?></div>
			</div>
		</div>
	</div>
</div>
