      ...
      <div class="no-mar no-bor clearfix box-head">
        <h5>
		  ...
		  <div class="pull-right space">
			  <a class="accordion-toggle js-toggle-icon js-no-pjax grayc no-under clearfix pull-right span1" href="#sources" data-parent="#accordion-admin-dashboard" data-toggle="collapse">
    ...
    <div id="sources" class="accordion-body in collapse over-hide">
      <div class="accordion-inner">
        ...
        <div class="row-fluid ver-space">
			<div class="span24">
                <div class="span12 sep-right space">
                    <section class="span dc no-mar">
					<h3 class="ver-mspace dl"><?php echo __l("Visits Per Source"); ?></h3>
						<?php
			...
			<section class="span24 dc sep-top">
			<h3 class="ver-mspace dl"><?php echo __l('Visits Per Country'); ?></h3>
				<?php
				$countries_arr = array();
