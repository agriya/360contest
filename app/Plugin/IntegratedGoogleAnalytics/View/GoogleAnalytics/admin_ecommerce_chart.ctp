<div class="js-ecommerce js-cache-load-admin-ecommerce_chart">
  <div class="accordion-group">
    <div class="accordion-heading bootstro" data-bootstro-step="2" data-bootstro-content="<?php echo __l(" Ecommerce represents the total transactions made in the selected period and transaction revenue for the site. It shows the pie chart representation for revenue gather by which source and pie chart representation for revenue gather by which contest resource either image or video.");?>" data-bootstro-width="600px" data-bootstro-title="Ecommerce">
    ...
    <div id="ecommerce" class="accordion-body in collapse over-hide">
	  ...
	  <?php echo $this->element('chart-admin_ecommerce_transaction_chart', array('select_range_id' => $select_range_id, 'cache' => array('config' => 'site_element_cache_15_min'))); ?>
        ...
        <div class="row-fluid ver-space">
			<section class="span12 no-mar dc sep-right space">
			<h3 class="ver-mspace dl"><?php echo __l("E-Commerce Per Source"); ?></h3>
						<?php
			  ...
			  <h3 class="ver-mspace dl"><?php echo __l("E-Commerce Per Resources"); ?></h3>
						<?php
