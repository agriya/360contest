...
<div>
  <dl class="dl-horizontal clearfix">
	...
	<dt><?php echo __l('Payment Type');?></dt>
      <dd><?php echo (!empty($sudopayTransactionLog['SudopayTransactionLog']['payment_type'])) ? $this->Html->cText($sudopayTransactionLog['SudopayTransactionLog']['payment_type']) : '--'; ?></dd>
