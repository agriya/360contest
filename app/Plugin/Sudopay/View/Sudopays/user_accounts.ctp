    ...
    <span class="span4  pull-right">
		<?php 
			...
			<?php } else {
				...
				echo $this->Html->link(__l('Connect'), array('controller' => 'sudopays', 'action' => 'add_account', $project, $gateways['SudopayPaymentGateway']['sudopay_gateway_id'], $user), array('class' => 'btn  ver-mspace'.$class));
			}
		?>
	</span>
	</div>
