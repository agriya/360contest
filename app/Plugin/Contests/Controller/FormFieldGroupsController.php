    ...
    public function admin_add() 
    {
        ...
        if (!empty($this->request->data)) {
            ...
            if (!empty($this->request->params['named']['type_id'])) {
                $this->request->data['FormFieldGroup']['contest_type_id'] = $this->request->params['named']['type_id'];
            }
        }
    }
            ...
            if ($this->FormFieldGroup->save($this->request->data)) {
                ...
                if ($this->RequestHandler->isAjax()) {
                    ...
                    $this->redirect(array(
                        'controller' => 'contest_types',
                        'action' => 'edit',
                        $this->request->data['FormFieldGroup']['contest_type_id'],
						'type' => 'form_fields'
                    ));
                }
            } else {
    ...
    public function admin_delete($id = null) 
    {
        ...
        if ($this->FormFieldGroup->delete($id)) {
			...
			$this->redirect(array(
				'controller' => 'contest_types',
				'action' => 'edit',
				$formFieldGroup['FormFieldGroup']['contest_type_id'],
				'type' => 'form_fields'
			));
        }
    }
