...
<div class="FormFieldGroups index js-response space">
  <ul class="breadcrumb">
    <li><?php echo $this->Html->link(sprintf(__l('%s Form and Groups'), Configure::read('project.alt_name_for_project_singular_caps')), array('controller' => 'resources','action' => 'index'),array('title' => sprintf(__l('%s Form and Groups'), Configure::read('project.alt_name_for_project_singular_caps'))));?><span class="divider">&raquo</span></li>
    <li class="active"><?php echo __l('Form Field Groups');?></li>
  </ul>
  <ul class="nav nav-tabs">
    <li>
    <?php echo $this->Html->link('<i class="icon-th-list blackc"></i>'.__l('List'), array('controller' => 'resources', 'action' => 'index'),array('class' => 'blackc', 'title' =>  __l('List'),'data-target'=>'#list_form', 'escape' => false));?>
    </li>
