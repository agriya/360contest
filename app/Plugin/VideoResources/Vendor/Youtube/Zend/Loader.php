...
class Zend_Loader
{
    ...
    public static function loadClass($class, $dirs = null)
    {
        ...
        if ((null !== $dirs) && !is_string($dirs) && !is_array($dirs)) {
            require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Exception.php';
    ...
    public static function loadFile($filename, $dirs = null, $once = false)
    {
         ...
         */
        if ($once) {
            include_once APP.'Plugin'.DS.'VideoResources'.DS.'Vendor'.DS.'Youtube'.DS.$filename;
        } else {
            include APP.'Plugin'.DS.'VideoResources'.DS.'Vendor'.DS.'Youtube'.DS.$filename;
        }
    ...
    {
        trigger_error(__CLASS__ . '::' . __METHOD__ . ' is deprecated as of 1.8.0 and will be removed with 2.0.0; use Zend_Loader_Autoloader instead', E_USER_NOTICE);
        require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Loader/Autoloader.php';
