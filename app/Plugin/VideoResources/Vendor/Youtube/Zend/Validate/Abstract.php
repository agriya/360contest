 ...
 */
require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend'.DS.'Validate'.DS.'Interface.php';
...
abstract class Zend_Validate_Abstract implements Zend_Validate_Interface
{
    ...
    public function setMessage($messageString, $messageKey = null)
    {
        ...
        if (!isset($this->_messageTemplates[$messageKey])) {
            require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend'.DS.'Validate'.DS.'Exception.php';
    ...
    public static function getDefaultTranslator()
    {
        if (null === self::$_defaultTranslator) {
            require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Registry.php';
