 ...
 */
require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend'.DS.'Validate'.DS.'Hostname.php';
...
class Zend_Uri_Http extends Zend_Uri
{
    ...
    protected function __construct($scheme, $schemeSpecific = '')
    {
        ...
        // Validate the URI
        if ($this->valid() === false) {
            require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Uri/Exception.php';
