 ...
 */
require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Gdata/Extension/OpenSearchTotalResults.php';

/**
 * @see Zend_Gdata_Extension_OpenSearchStartIndex
 */
require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Gdata/Extension/OpenSearchStartIndex.php';

/**
 * @see Zend_Gdata_Extension_OpenSearchItemsPerPage
 */
require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Gdata/Extension/OpenSearchItemsPerPage.php';
