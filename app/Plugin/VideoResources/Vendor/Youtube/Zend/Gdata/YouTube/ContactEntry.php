 ...
 */
require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Gdata/YouTube/UserProfileEntry.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Status
 */
require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Gdata/YouTube/Extension/Status.php';
