 ...
 * Zend_Gdata_Feed
 */
require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Gdata/App/Feed.php';

/**
 * Zend_Gdata_Http_Client
 */
require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Http/Client.php';

/**
 * Zend_Version
 */
require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Version.php';

/**
 * Zend_Gdata_App_MediaSource
 */
require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Gdata/App/MediaSource.php';

/**
 * Zend_Uri/Http
 */
require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Uri/Http.php';
...
class Zend_Gdata_App
{
    ...
    {
        require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Http/Client/Exception.php';
        ...
        if ($body instanceof Zend_Gdata_MediaMimeStream) {
            ...
            if ($oldHttpAdapter instanceof Zend_Http_Client_Adapter_Proxy) {
                require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Gdata/HttpAdapterStreamingProxy.php';
                $newAdapter = new Zend_Gdata_HttpAdapterStreamingProxy();
            } else {
                require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Gdata/HttpAdapterStreamingSocket.php';
