 ...
 */
require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Gdata/Photos/UserFeed.php';

/**
 * @see Zend_Gdata_Photos_AlbumFeed
 */
require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Gdata/Photos/AlbumFeed.php';

/**
 * @see Zend_Gdata_Photos_PhotoFeed
 */
require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Gdata/Photos/PhotoFeed.php';
