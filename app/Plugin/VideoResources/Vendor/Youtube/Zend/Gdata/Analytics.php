 ...
 */
require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Gdata/Analytics/AccountEntry.php';

/**
 * @see Zend_Gdata_Analytics_AccountFeed
 */
require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Gdata/Analytics/AccountFeed.php';

/**
 * @see Zend_Gdata_Analytics_DataEntry
 */
require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Gdata/Analytics/DataEntry.php';

/**
 * @see Zend_Gdata_Analytics_DataFeed
 */
require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Gdata/Analytics/DataFeed.php';

/**
 * @see Zend_Gdata_Analytics_DataQuery
 */
require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Gdata/Analytics/DataQuery.php';

/**
 * @see Zend_Gdata_Analytics_AccountQuery
 */
require_once APP."Plugin".DS."VideoResources".DS."Vendor".DS."Youtube".DS.'Zend/Gdata/Analytics/AccountQuery.php';
