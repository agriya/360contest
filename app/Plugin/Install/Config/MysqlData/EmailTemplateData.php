        ...
        <tr>
          <td style=\"padding: 20px 30px 5px;\"><p style=\"color: #545454; font-size: 18px;\">Dear Subscriber,</p>            
            <table border=\"0\" width=\"100%\">
              <tbody>	  
                <tr>
                  <td><p style=\" color: #545454; margin: 0pt 20px; font-size: 16px; text-align: left; padding: 5px 0px;\">##SITE_NAME## team want to add you as a user in ##SITE_NAME##.Click the below link to join us...##INVITE_LINK##</p></td><td><p style=\" color: #545454; margin: 0pt 20px; font-size: 16px; text-align: left; padding: 5px 0px;\">Invite Code: ##INVITE_CODE##</p></td>
                </tr>
              </tbody>
            </table>
            <p style=\" color: #545454; margin: 0pt 20px; font-size: 16px; text-align: center; padding: 15px 0px;\">&nbsp;</p></td>
    ...
    <tbody>
      <tr>
		...
		array(
			...
			'modified' => '2014-03-10 00:00:00',
			'from' => '##FROM_EMAIL##',
			'reply_to' => '##REPLY_TO_EMAIL##',
			'name' => 'Password Changed',
			'description' => 'we will send this mail, when user changed his password.',
			'subject' => 'Password Changed',
			'email_content' => 'Dear ##USERNAME##, Successfully you have changed your password at ##SITE_NAME##. If you did not request this action , please contact us ##SUPPORT_EMAIL## Thanks, ##SITE_NAME## ##SITE_URL##',
			'email_html_content' => '<link href=\"http://fonts.googleapis.com/css?family=Open+Sans\" rel=\"stylesheet\" type=\"text/css\" /><div style=\"margin: 5px 0pt; padding: 20px; width: 700px; font-family: Open Sans,sans-serif; background-color: #f2f2f2; background-repeat: no-repeat;-webkit-border-radius: 10px;-moz-border-radius: 10px;border-radius: 10px;\">  <table cellspacing=\"0\" cellpadding=\"0\" width=\"720px\">    <tbody>      <tr>        <td align=\"center\"><p style=\"text-align: center; font-size: 11px; color: #929292; margin: 3px;\">Be sure to add <a style=\"color: #30BCEF;\" title=\"Add ##FROM_EMAIL## to your whitelist\" href=\"mailto:##FROM_EMAIL##\" target=\"_blank\">##FROM_EMAIL##</a> to your address book or safe sender list so our emails get to your inbox.</p></td>      </tr>    </tbody>  </table>  <div style=\"border-bottom: 1px solid #ccc; margin: 0pt; background: -moz-linear-gradient(top, #ffffff 0%, #f2f2f2 100%);background: -webkit-linear-gradient(top, #ffffff 0%,#f2f2f2 100%);background: -o-linear-gradient(top, #ffffff 0%,#f2f2f2 100%);background: -ms-linear-gradient(top, #ffffff 0%,#f2f2f2 100%);filter: progid:DXImageTransform.Microsoft.gradient( startColorstr=\'#ffffff\', endColorstr=\'#f2f2f2\',GradientType=0 );  min-height: 70px;\"><table cellspacing=\"0\" cellpadding=\"0\" width=\"700\"><tbody><tr><td  valign=\"top\" style=\"padding:14px 0 0 10px; width: 110px; min-height: 37px;\"><a style=\"color: #0981be;\" title=\"##SITE_NAME##\" href=\"#\" target=\"_blank\"></a><a style=\"color: #0981be;\" title=\"##SITE_NAME##\" href=\"#\" target=\"_blank\"><img style=\"padding-right: 15px; border: 0px 1px 0px 0px none solid none none -moz-use-text-color #333333 -moz-use-text-color -moz-use-text-color;\" src=\"##SITE_URL##/img/logo.png\" alt=\"[Image: ##SITE_NAME##]\" /></a></td><td width=\"505\" align=\"center\" valign=\"top\" style=\"padding-left: 15px; width: 250px; padding-top: 16px;\"><a style=\"color: #0981be;\" title=\"##SITE_NAME##\" href=\"#\" target=\"_blank\"></a></td><td width=\"21\" align=\"right\" valign=\"top\" style=\"padding-right: 20px; padding-top: 21px;\">&nbsp;</td></tr></tbody></table></div>    <div style=\" padding: 20px; background-repeat: no-repeat; background-color: #ffffff; box-shadow: 0 0 7px rgba(0, 0, 0, 0.067);\">    <table style=\"background-color: #ffffff;\" width=\"100%\">      <tbody>                <tr>          <td style=\"padding: 20px 30px 5px;\"><p style=\"color: #545454; font-size: 18px;\">Dear ##USERNAME##,</p>            <table border=\"0\" width=\"100%\">              <tbody>                <tr>                  <td><p style=\" color: #545454; margin: 0pt 20px; font-size: 16px; text-align: left; padding: 5px 0px;\">Successfully you have changed your password at ##SITE_NAME##. If you did not request this action , please contact us ##SUPPORT_EMAIL## </p></td>                </tr>              </tbody>            </table>            <p style=\" color: #545454; margin: 0pt 20px; font-size: 16px; text-align: center; padding: 15px 0px;\">&nbsp;</p></td>        </tr>        <tr>          <td><div style=\"border-top: 1px solid #d6d6d6; padding: 15px 30px 25px; margin: 0pt 30px;\">              <h4 style=\" font-size: 22px; font-weight: bold; text-align: center; margin: 0pt 0pt 5px; line-height: 26px; color: #30BCEF;\">Thanks,</h4>              <h5 style=\" color: #545454; line-height: 20px; text-align: center; margin: 0pt; font-size: 16px;\">##SITE_NAME## - <a style=\"color: #30BCEF;\" title=\"##SITE_NAME## - Collective Buying Power\" href=\"##SITE_LINK##\" target=\"_blank\">##SITE_URL##</a></h5>            </div></td>        </tr>      </tbody>    </table>    <table style=\"margin-top: 2px; background-color: #f5f5f5;\" width=\"100%\">      <tbody>        <tr>          <td><p style=\" color: #000; font-size: 12px; text-align: center; line-height: 16px; margin: 10px;\">Need help? Have feedback? Feel free to <a style=\"color: #30BCEF;\" title=\"Contact ##SITE_NAME##\" href=\"##CONTACT_URL##\" target=\"_blank\">Contact Us</a></p></td>        </tr>      </tbody>    </table>  </div>  <table cellspacing=\"0\" cellpadding=\"0\" width=\"720px\">    <tbody>      <tr>        <td align=\"center\"><p style=\"font-size: 11px; color: #929292; margin: 3px; padding-top: 10px;\">Delivered by <a style=\"color: #30BCEF;\" title=\"##SITE_NAME##\" href=\"##SITE_LINK##\" target=\"_blank\">##SITE_NAME##</a></p></td>      </tr>    </tbody>  </table></div>',
