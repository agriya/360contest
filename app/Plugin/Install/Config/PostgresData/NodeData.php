...
<li><span style=\"white-space: pre;\"> </span>Testing</li>
...
',
		...
		array(
			...
			'slug' => 'privacy',
			'body' => '<p>For each visitor to our Web page our Web server automatically recognizes no information regarding the domain or e-mail address.</p>
...
<p>With respect to cookies. We use cookies to record session information such as items that consumers add to their shopping cart.</p>
...
<p>Persons who supply us with their telephone numbers on-line will only receive telephone contact from us with information regarding orders they have placed on-line. Please provide us with your name and phone number. We will be sure your name is removed from the list we share with other organizations.</p>
...
<p>Upon request we offer visitors the ability to have inaccuracies corrected in contact information transaction information.</p>
...
',
		...
		array(
			...
			'slug' => 'aup',
			'body' => '<div class=\"aup\"><p>You are independently responsible for complying with all applicable  laws in all of your actions related to your use of PayPal&rsquo;s services,  regardless of the purpose of the use. In addition, you must adhere to  the terms of this Acceptable Use Policy.</p>
...
<li> involve gambling, gaming and/or any other activity with an  entry fee and a prize, including, but not limited to casino games,  sports betting, horse or greyhound racing, lottery tickets, other  ventures that facilitate gambling, games of skill (whether or not it is  legally defined as a lottery) and sweepstakes unless the operator has  obtained prior approval from PayPal and the operator and customers are  located exclusively in jurisdictions where such activities are permitted  by law. </li>
			...
			'excerpt' => '<div class=\"aup\"><p>You are independently responsible for complying with all applicable  laws in all of your actions related to your use of PayPal&rsquo;s services,  regardless of the purpose of the use. In addition, you must adhere to  the terms of this Acceptable Use Policy.</p>
...
<li> involve gambling, gaming and/or any other activity with an  entry fee and a prize, including, but not limited to casino games,  sports betting, horse or greyhound racing, lottery tickets, other  ventures that facilitate gambling, games of skill (whether or not it is  legally defined as a lottery) and sweepstakes unless the operator has  obtained prior approval from PayPal and the operator and customers are  located exclusively in jurisdictions where such activities are permitted  by law. </li>
		...
		array(
			...
			'title' => 'Benefits',
			'slug' => 'benefits',
			'body' => '<li>Get the design that you really want by choosing from custom designs, instead of settling on a design from a handful of options that a traditional design firm provides.</li>

<li>What you see is what you get. You can browse current and past contests to see exactly what you will get for your money.</li>

<li>Fast Selection Process - rank dozens of design in seconds.</li>

<li>Full Legal Ownership of your new design. Once you pay the winner of your contest, the logo is exclusively yours.</li>',
			'excerpt' => '<li>Get the design that you really want by choosing from custom designs, instead of settling on a design from a handful of options that a traditional design firm provides.</li>
...
<li>Full Legal Ownership of your new design. Once you pay the winner of your contest, the logo is exclusively yours.</li>',
			...
			'comment_count' => '0',
			'promote' => '',
			'path' => '/node/type:page/slug:benefits',
			'terms' => '',
			'sticky' => '',
			'lft' => '17',
			'rght' => '18',
			'visibility_roles' => '',
			'type' => 'page',
			'updated' => '2013-01-31 15:30:24',
			'created' => '2013-01-31 15:30:27',
			'meta_keywords' => '',
			'meta_description' => ''
		),
		array(
...
Duis id lectus eros. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Fusce eleifend eros quis ligula porta rutrum mattis non risus. Donec eget neque a turpis elementum egestas nec a enim. Ut ut quam lorem, eget dapibus dolor. Vestibulum nec turpis erat, eget luctus magna. Phasellus ac tincidunt arcu. Etiam et augue massa. Donec eget justo enim. Quisque eget orci eu orci malesuada vestibulum non at magna. Fusce malesuada malesuada faucibus. Nulla ultrices nibh in tellus pellentesque mollis commodo velit placerat. Fusce eget velit velit, vitae adipiscing justo.',
		...
		array(
			...
			'slug' => 'request-changes',
			'body' => '<div class=\"clearfix img-rounded thumbnail ver-mspace span space\">

	<div class=\"span9 sep-right\">

		<h3>What you can request</h3>

		<ul class=\"unstyled\">

			<li class=\"smspace\"><span><i class=\"icon-ok greenc text-16\"></i></span><span>This business name to be incorporated</span></li>

			<li class=\"smspace\"><span><i class=\"icon-ok greenc text-16\"></i></span><span>A tag line your business has</span></li>

			<li class=\"smspace\"><span><i class=\"icon-ok greenc text-16\"></i></span><span>Any simple text based changes</span><span class=\"show hor-space hor-mspace\">(bolding, line breaking, capitalization etc)</span></li>

			<li class=\"smspace\"><span><i class=\"icon-ok greenc text-16\"></i></span><span>Basic colour changes</span></li>

			<li class=\"smspace\"><span><i class=\"icon-ok greenc text-16\"></i></span><span>A different font</span><span class=\"show hor-space hor-mspace\">(If it\'s free or part of the Adobe Font Folio family)</span></li>

		</ul>

	</div>

	<div class=\"span11 hor-space hor-mspace pull-right\">

		<h3>What you can\'t request</h3>

		<ul class=\"unstyled\">

			<li class=\"smspace\"><span><i class=\"icon-remove redc text-16\"></i></span><span>Layout/structural changes to the logo itself</span></li>

			<li class=\"smspace\"><span><i class=\"icon-remove redc text-16\"></i></span><span>Different formats and variations to use in different situations</span></li>

			<li class=\"smspace\"><span><i class=\"icon-remove redc text-16\"></i></span><span>Variety of options for you to review</span></li>

			<li class=\"smspace\"><span><i class=\"icon-remove redc text-16\"></i></span><span>Vague ideas (e.g. a cursive font)</span></li>
			...
			'comment_count' => '0',
			'promote' => '',
			'path' => '/node/type:page/slug:request-changes',
			'terms' => '',
			'sticky' => '',
			'lft' => '1',
			'rght' => '1',
