    ...
    <div class="main clearfix">
      <div class="side-content grid_7">
        ...
        <ol class="list round-4 grid_6">
          ...
          <li class="round-4<?php if ($this->request->params['action'] == 'database') { ?> active<?php } ?>">4. Database</li>
          <li class="round-4<?php if ($this->request->params['action'] == 'configuration') { ?> active<?php } ?>">5. BookorRent Configuration</li>
          <li class="round-4<?php if ($this->request->params['action'] == 'finish') { ?> active<?php } ?>">6. Installation is Complete!</li>
        </ol>
      </div>
