<div class="install form">
	...
	<div class="content-block round-4">
		...
		<fieldset>
		  <h3><?php echo __l('Google'); ?></h3>
		  <div class="configration-details info-details">Google is used for login using its account details. For doing above, our site must be configured with existing Google account. <a href="http://dev1products.dev.agriya.com/doku.php?id=google-hybridauth-setup" target="_blank"> http://dev1products.dev.agriya.com/doku.php?id=google-hybridauth-setup </a></div>
		  <?php echo $this->Form->input('google.consumer_key', array('label' => __l('Client ID'))); ?>
		  <?php echo $this->Form->input('google.consumer_secret', array('label' => __l('Client Secret'))); ?>
		</fieldset>
		<fieldset>
		  <h3><?php echo __l('Yahoo'); ?></h3>
		  <div class="configration-details info-details">Yahoo is used for login using its account details. For doing above, our site must be configured with existing Yahoo account. <a href="http://dev1products.dev.agriya.com/doku.php?id=yahoo-api-setup" target="_blank"> http://dev1products.dev.agriya.com/doku.php?id=yahoo-api-setup </a></div>
		  <?php echo $this->Form->input('yahoo.consumer_key', array('label' => __l('Consumer Key'))); ?>
		  <?php echo $this->Form->input('yahoo.consumer_secret', array('label' => __l('Consumer Secret'))); ?>
		</fieldset>
		<fieldset>
		  <h3><?php echo __l('LinkedIn'); ?></h3>
		  <div class="configration-details info-details">LinkedIn is used for login using its account details. For doing above, our site must be configured with existing LinkedIn account.<a href="http://dev1products.dev.agriya.com/doku.php?id=linkedin-hybridauth-setup" target="_blank"> http://dev1products.dev.agriya.com/doku.php?id=linkedin-hybridauth-setup </a></div>
		  <?php echo $this->Form->input('linkedin.consumer_key', array('label' => __l('API Key'))); ?>
		  <?php echo $this->Form->input('linkedin.consumer_secret', array('label' => __l('Secret Key'))); ?>
		</fieldset>
		<fieldset>
		  <h3><?php echo __l('SolveMedia'); ?></h3>
		  <div class="configration-details info-details">Solve Media offers revenue sharing by showing Ads in CAPTCHA display.<a href="http://dev1products.dev.agriya.com/doku.php?id=solvemedia-setup" target="_blank"> http://dev1products.dev.agriya.com/doku.php?id=solvemedia-setup </a></div>
		  <?php echo $this->Form->input('captcha.challenge_key', array('label' => __l('Challenge Key'))); ?>
		  <?php echo $this->Form->input('captcha.verification_key', array('label' => __l('Verification Key'))); ?>
		  <?php echo $this->Form->input('captcha.hash_key', array('label' => __l('Authentication Hash Key'))); ?>
		</fieldset>
	</div>
	<div class="clearfix">
