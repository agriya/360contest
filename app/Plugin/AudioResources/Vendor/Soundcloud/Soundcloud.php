...
class Services_Soundcloud
{
    ...
    function post($path, $postData = array(), $curlOptions = array())
    {
		...
		//$postData['username'] ='productdemo.admin@gmail.com';
        // $postData['password'] ='Agriya*12';
    ...
    protected function _request($url, $curlOptions = array())
    {
		...
		$response_data = json_decode($this->_lastHttpResponseBody, true);
		if(empty($response_data)){
			$response_data = array();
		}
		$response_data = array_merge($response_data, $info);
