<div class="space">
    ...
    <div class="clearfix">
     ...
     <div class="thumbnail space clearfix theme-img">

    <?php
      if (!Configure::read('site.theme')) {
        echo $this->Html->tag('div', $this->Html->image($currentTheme['screenshot'], array('class' => 'thumbnail')), array('class' => 'clearfix'));
      } else {
        echo $this->Html->tag('div', $this->Html->image('/theme/' . Configure::read('site.theme') . '/img/' . $currentTheme['screenshot'], array('class' => 'thumbnail')), array('class' => 'span'));
      }
    ?>
   ...
   <div class="thumbnail">
    ...
    <?php
      ...
      if (empty($is_themes_available)) {
        echo '<li class="notice"><i class="icon-warning-sign grayc"></i> ' . sprintf(__l('No %s available'), __l('Themes')) . '</li>';
      }
    ?>
    </ol>
    </div>
