    ...
    <div class="accordion-heading">
      <div class="no-mar no-bor clearfix box-head">
        <h5>
          ...
          <a class="accordion-toggle js-toggle-icon js-no-pjax grayc no-under clearfix pull-right no-pad span1" href="#registration" data-parent="#accordion-admin-dashboard" data-toggle="collapse">
