        ...
        $this->
        {
            ...
            foreach($userCashWithdrawalIds as $userCashWithdrawalId) {
                ...
                if (!empty($userCashWithdrawalId) && !empty($cash_withdraw)) {
                    $transaction_id = $this->User->Transaction->log($cash_withdraw['UserCashWithdrawal']['id'], 'Withdrawals.UserCashWithdrawal', ConstPaymentGateways::SudoPay, ConstTransactionTypes::AmountRefundedForRejectedWithdrawalRequest);
