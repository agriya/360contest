                ...
                if ($actionid == ConstWithdrawalStatus::Pending) {
                    ...
                    foreach($canceled_withdraw_requests as $canceled_withdraw_request) {
                        ...
                        if (!empty($canceled_withdraw_request)) {
                            $this->UserCashWithdrawal->User->Transaction->log($canceled_withdraw_request['UserCashWithdrawal']['id'], 'Withdrawals.UserCashWithdrawal', $canceled_withdraw_request['UserCashWithdrawal']['payment_gateway_id'], ConstTransactionTypes::FailedWithdrawalRequestRefundToUser);
                        }
