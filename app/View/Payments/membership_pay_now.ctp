...
<fieldset class="form-block">
	<legend><?php echo __l('Select Payment Type');?></legend>
   	<?php echo $this->element('payment-get_gateways', array('model' => 'User', 'type' => 'is_enable_for_signup','foreign_id' => $this->request->data['User']['id'], 'transaction_type' => ConstPaymentType::SignupFee, 'is_enable_wallet'=>0, 'cache' => array('config' => 'sec')));?>
</fieldset>
