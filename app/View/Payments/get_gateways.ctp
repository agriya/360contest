<div class="hor-space bot-mspace payment-gateways payment-type ver-space">
	...
	?>
	<div id="paymentgateways-tab-container" class="gateways-list">
		<ul class="nav nav-tabs no-mar">
			<?php foreach($gateway_groups As $gateway_group) { ?>
				<li><a href="#paymentGateway-<?php echo $gateway_group['id']; ?>" class="js-no-pjax clearfix" data-toggle="tab"><div class="pull-left">
...
<div class="submit-block form-payment-panel clearfix">
	<div class="submit">
		...
		<div class= "js-normal-sudopay hide">
			<?php
				echo $this->Form->submit(__l('Pay Now'), array('name' => 'data['.$model.'][wallet]', 'div' => false, 'id' => 'sudopay_button', 'class' => 'js-update-order-field btn btn-large'));
		?>
		</div>
	</div>   
</div>