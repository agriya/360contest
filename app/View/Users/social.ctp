...
<section class="clearfix">
  ...
  <div class="row ver-space sep-bot dc">
    ...
    <?php echo $this->Html->link($this->Html->image('facebook.png', array('alt' => __l('Login with Facebook'),'class'=>'img')), '#', array('escape' => false,'class' => "js-connect js-no-pjax {'url':'$url', 'r':'register'}")); ?>
    </div>
  </div>
  </div>
  <?php endif; ?>
  ...
  <div class="span7 offset3 bot-space">
   <?php $url = Router::url(array('controller' => 'users', 'action' => 'login', 'type' => 'twitter', 'admin' => false), true); ?>
    <p class="row"><?php echo $this->Html->link($this->Html->image('twitter.png', array('alt' => __l('Login with Twitter'),'class'=>'img')), '#', array('escape' => false, 'class' => "js-connect js-no-pjax {'url':'$url', 'r':'register'}")); ?></p>
  </div>
  </div>
  <?php endif; ?>
  ...
  <div class="span7 offset3 bot-space">
    ...
    <p class="row"><?php echo $this->Html->link($this->Html->image('login-linkedin.png', array('alt' => __l('Login with LinkedIn'),'class'=>'img')), '#', array('escape' => false, 'class' => "js-connect js-no-pjax {'url':'$url', 'r':'register'}")); ?></p>
  </div>
  </div>
  <?php endif; ?>
  ...
  <div class="span7 offset3 bot-space">
    ...
    <p class="row"><?php echo $this->Html->link($this->Html->image('login-yahoo.png', array('alt' => __l('Login with Yahoo!'),'class'=>'img')), '#', array('escape' => false, 'class' => "js-connect js-no-pjax {'url':'$url', 'r':'register'}")); ?></p>
  </div>
  </div>
  <?php endif;?>
  ...
  <div class="span7 offset3 bot-space">
    ...
    <p class="row"><?php echo $this->Html->link($this->Html->image('login-google.png', array('alt' => __l('Login with Google'),'class'=>'img')), '#', array('escape' => false,'class' => "js-connect js-no-pjax {'url':'$url', 'r':'register'}")); ?></p>
  </div>
  </div>
  <?php endif;?>
  ...
  <div class="span7 offset3 bot-space">
    ...
    <div class="row"><?php echo $this->Html->link($this->Html->image('login-googleplus.png', array('alt' => __l('Login with GooglePlus'),'class'=>'img')), '#', array('escape' => false,'class' => "js-connect js-no-pjax {'url':'$url', 'r':'register'}")); ?></div>
  </div>
  </div>
  <?php endif;?>
  ...
  <div class="span7 offset3 ">
    ...
    <p class="row"><?php echo $this->Html->link($this->Html->image('login-openid.png', array('alt' => __l('Login with OpenId'),'class'=>'img')), '#', array('escape' => false,'class' => "js-connect js-no-pjax {'url':'$url', 'r':'register'}")); ?></p>
  </div>
  </div>
   <?php endif;?>
    <h4 class="dc pr  bot-space"><span class="space or-hor pa textb"><?php echo __l('Or');?></span></h4>
	<div class="clearfix ver-space">
			<div class="dc grid_9 ">
				...
				<p><span class="show"><?php echo __l('By signing up you agree to the  '); ?><?php echo $this->Html->link(__l('Terms & Conditions'), array('controller' => 'pages', 'action' => 'view', 'terms'), array('class' => 'js-no-pjax', 'target' => '_blank', 'title' => __l('Terms & Conditions'), 'escape' => false)); ?></span></p>
