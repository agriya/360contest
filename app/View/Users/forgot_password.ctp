...
<div class=" thumbnail">
<div class="info-details alert alert-info">
	<?php echo __l('Enter your Email, and we will send you instructions for resetting your password.'); ?>
</div>
    <?php
	echo $this->Form->create('User', array('action' => 'forgot_password', 'class' => 'form-large-fields form-horizontal ver-space '));
    ...
    <?php } ?>
    <?php endif; ?>
    <div class="submit-block clearfix offset2 hor-space">
	 <div class="offset1 ver-space">
    <?php
    	echo $this->Form->submit(__l('Send'), array('div' => false));
    ?>
	</div>
    </div>
     <?php
