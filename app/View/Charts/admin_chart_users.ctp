...
<section class="thumbnail no-pad top-mspace bot-mspace sep">
            <div class="no-mar no-bor clearfix box-head space sep-bot">
              ...
              <div class="pull-right"> <a href="#collapseTwo" data-parent="#accordion2" data-toggle="collapse" class=" js-toggle-icon pull-right blackc accordion-toggle span1"><?php echo $arrow; ?></a>
