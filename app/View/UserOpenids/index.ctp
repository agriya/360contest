...
?>
	<li<?php echo $class;?>>
		...
		<div class="actions"><?php echo $this->Html->link(__l('Delete'), array('action'=>'delete', $userOpenid['UserOpenid']['id']), array('class' => 'delete js-confirm js-no-pjax', 'title' => __l('Delete')));?></div>
	</li>
<?php
    endforeach;
else:
?>
	<li>
		<p class="notice"><?php echo sprintf(__l('No %s available'), __l('OpenIDs'));?></p>
	</li>
<?php
endif;
?>
