<?php /* SVN: $Id: $ */ ?>
<h2><?php echo sprintf(__l('Edit %s Settings'), $paymentGateway['PaymentGateway']['display_name']);?></h2>
<div id="breadcrumb">
...
if (!empty($paymentGatewaySettings)) {
	echo $this->Form->create('PaymentGatewaySetting', array('action' => 'update', 'class' => 'form-horizontal'));
