<div class="space"><div class="nodes form thumbnail ">
	<?php echo $this->Form->create('Node', array('url' => array('controller' => 'nodes', 'action' => 'add','admin' => true, $typeAlias),'class' => 'form-large-fields form-horizontal'));?>
	<fieldset>
		<div class="panel-container">
			...
			<div class="tab-content" id="myTabContent">
				<div id="node-main" class="tab-pane fade in active">
					<?php echo $this->Form->input('parent_id', array('type' => 'select', 'options' => $nodes, 'empty' => __l('Please Select')));
				...
				<?php if (count($taxonomy) > 0) { ?>
					<div id="node-terms">
						<?php foreach ($taxonomy AS $vocabularyId => $taxonomyTree) {
				...
				<?php if ($type['Type']['comment_status'] != 0) { ?>
					<div id="node-comments" class="tab-pane fade">
						<?php echo $this->Form->input('comment_status', array(
							'type' => 'radio',
							'div' => array('class' => 'radio submit-block'),
							'options' => array(
								'0' => __l('Disabled'),
								'1' => __l('Read only'),
								'2' => __l('Read/Write'),
				...
				<div id="node-meta" class="tab-pane fade">
					<?php echo $this->Form->input('meta_keywords', array('label' => __l('Meta Keywords'), 'type' => 'text')); ?> <?php echo $this->Form->input('meta_description', array('label' => __l('Meta Description'), 'type' => 'textarea')); ?>
				</div>
			...
			<?php echo $this->Layout->adminTabs(); ?>
			<div class="pull-left ">
				<div class="submit-block clearfix span24 offset4">
					<?php echo $this->Form->submit(__l('Apply'), array('name' => 'apply','div'=>false));
