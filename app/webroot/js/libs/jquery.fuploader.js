...
$.fn.fuploader=function(){
        ...
        $('.flashUploader', $this).each(function(j) {
            ...
            var $oUpload = $(this).uploader( {
                ...
                logging: "1",
                backendScript: __cfg('path_relative') + $this.metadata().controller + '/flashupload/' + $.cookie('PHPSESSID'),
...
/**
                ...
                uploaderReady: function() {
                    ...
                    if ($this.parent().find('.normal-uploader').length) {
						...
						jQuery('#' + this._settings.containerID).after('<div class="uploader-error"></div>');
...
/**
                ...
                fileAdded: function(args) {
                    ...
                    sHTML += '</div></div>';
                    sHTML += '<div class="js-hidden-file"><input type="hidden" name="data[ContestUser][is_file_added]" value="1"/></div>';
...
/**
                ...
                queueCleared: function() {
                    ...
                    jQuery('.clearAll', $this).hide();
                    jQuery('.uploader-error', $this).hide();
                    jQuery('.js-hidden-file', $this).remove();
                },
