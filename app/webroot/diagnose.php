...
<head>
<title>360Contest - Diagnostic Tool</title>
<style type="text/css">
body{
	color:#4c4c4c;
	line-height:18px;
            ...
            foreach($db_info['payment_gateway']['gateway'] as $key => &$gateway) {
                foreach($db_info['payment_gateway']['gateway_settings'] as &$settings) {
                    if ($gateway['id'] == $settings['payment_gateway_id']) {
                        if ($settings['key'] != 'is_enable_for_add_to_wallet' && $settings['key'] != 'is_enable_for_contest_listing' && $settings['key'] != 'is_enable_for_signup') {
...
<h1>360Contest Diagnostic Tool</h1>
...
<p class="info-details">
    ...
    <span>
		...
		<br/>For more info: <a href="http://dev1products.dev.agriya.com/doku.php?id=360contest-install#setting_up_files" target="_blank">http://dev1products.dev.agriya.com/doku.php?id=360contest-install#setting_up_files</a>
	</span>
</p>
...
<p class="info-details">
    ...
    <span>
		...
		<br/>For more info: <a href="http://dev1products.dev.agriya.com/doku.php?id=360contest-install#setting_up_database" target="_blank">http://dev1products.dev.agriya.com/doku.php?id=360contest-install#setting_up_database</a>
	</span>
</p>
...
<p class="info-details">
	<span> Note: </span>
    <span>
		<br/>For more info: <a href="http://dev1products.dev.agriya.com/doku.php?id=360contest-install#manage_settings" target="_blank">http://dev1products.dev.agriya.com/doku.php?id=360contest-install#manage_settings</a>
	</span>
</p>
<?php
/**
...
<table border="2" class="list">
  ...
  <tr>
    ...
    <th>Enable for Contest Listing?</th>
 ...
 * @since 		2012-03-07
 **/
        echo ($gateway['is_enable_for_contest_listing']) ? 'Yes' : 'No'; ?></td>
	<td><?php
/**
 *
 * @package		360Contest
 ...
 * @since 		2012-03-07
 **/
        echo ($gateway['is_enable_for_signup']) ? 'Yes' : 'No'; ?></td>
  </tr>
  <?php
/**
 *
