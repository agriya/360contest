 ...
 */
    ...
    function uploader($fieldName, $options = array())
    {
        ...
        $uploader = '<div class="pull-left no-mar js-uploader {controller:\'' . $controller . '\',filecount:\'' . $count . '\',queuefilesize:\'' . $queuefilesize . '\',filesize:\'' . $filesize . '\',filetype:\'' . $filetype . '\',movieid:\'' . $movieid . '\',session:\'' . session_id() . '\',redirectURL:\'' . $redirectURL . '\'}">';
        ...
        for ($i = 0; $i < $count; $i++) {
            ...
            $options['label'] = __l('Screenshot or Thumbnail');
